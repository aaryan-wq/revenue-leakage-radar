...
const HEADLINE_LINES = ["Your billing exports", "hold recoverable", "revenue"];
  ...
  return (
    <section className="relative mx-auto max-w-marketing px-6 pt-20 pb-16 md:px-10 md:pt-28 md:pb-20">
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <HairlineCard padding="lg" className="relative overflow-hidden border-primary/15">
            ...
            <div className="relative space-y-8">
              <div className="rounded-xl border border-line bg-secondary/35 px-6 py-8 text-center md:px-8">
                <p className="text-overline text-muted-foreground">Industry leakage benchmark</p>
                <motion.p
              ...
              <p className="text-left text-caption text-muted-foreground">
                Illustrative benchmark only. Upload billing exports below for deterministic findings
                from your records.
              </p>
            </div>
          </HairlineCard>
        ...
        <Reveal className="text-center lg:order-2 lg:text-left">
          <motion.p
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap justify-center gap-x-6 gap-y-2 lg:justify-start"
          >
            {["Deterministic rules", "Evidence-backed findings", "No integrations"].map((item) => (
          ...
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.9, ease: glide, delay: 0.8 }}
          ...
          >
            <Link href="/upload">
              <Button
                ...
                onClick={() =>
                  captureEvent(AnalyticsEvents.FREE_AUDIT_CTA_CLICKED, { source: "landing_hero" })
                }
              >
